...
describe('Transaction FiscalYear Methods', function () {

    it('can check if transaction is locked in specific fiscal year', function () {
    ...
    it('can get locked at timestamp for fiscal year', function () {
        $fiscalYear = FiscalYear::factory()->create(['year' => 2024]);
    ...
    it('returns null for unlocked transaction', function () {
        $transaction = Transaction::factory()->create();

        expect($transaction->getLockedAtForFiscalYear(2024))->toBeNull();
    });

    it('can scope unlocked transactions', function () {
        $fiscalYear = FiscalYear::factory()->create(['year' => 2024]);
    ...
    it('can scope locked transactions', function () {
        $fiscalYear = FiscalYear::factory()->create(['year' => 2024]);
    ...
    it('checks if transaction is editable based on session year', function () {
...
describe('Transaction Fiscal Year Lock Methods', function () {

    it('returns null when fiscal year does not exist', function () {
        $transaction = Transaction::factory()->create(['date' => '2024-06-15']);

        expect($transaction->getLockedAtForFiscalYear(2024))->toBeNull();
    });

    it('returns null when transaction is not locked', function () {
    ...
    it('returns locked_at timestamp when transaction is locked', function () {
        $fiscalYear = FiscalYear::factory()->create(['year' => 2024]);
        $transaction = Transaction::factory()->create(['date' => '2024-06-15']);
    ...
    it('checks if transaction is locked correctly', function () {
        $fiscalYear = FiscalYear::factory()->create(['year' => 2024]);
        $transaction = Transaction::factory()->create(['date' => '2024-06-15']);
