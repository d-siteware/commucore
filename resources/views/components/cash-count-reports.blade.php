<section class="space-y-6 my-3 ">
    ...
    @forelse(\App\Models\Accounting\CashCount::query()->whereYear('cash_counts.counted_at', \App\Models\Accounting\FiscalYear::getCurrent()?->year ?? date('Y'))->latest()->take(2)->get() as $counting)
