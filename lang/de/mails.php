...
return [
    ...
    'tab' => [
        'create' => 'Erstellen',
        'history' => 'Historie',
        'external_list' => 'Externe Liste',
    ],
    'tool' => [
        'options_heading' => 'Optionen zum E-Mail Versand',
        'reason' => 'Grund des Schreibens',
        'new_event' => 'Neue Veranstaltung',
        'new_article' => 'Neuer Artikel',
        'change' => 'Änderung Artikel/Veranstaltung',
        'include_external_list' => 'Externe Mailingliste einschließen',
        'include_external_list_desc' => 'Wenn aktiviert wird ein Link am Ende der E-Mail eingefügt der zu der jeweiligen Seite führt.',
        'create_link' => 'Link erstellen',
        'create_link_desc' => 'Wenn aktiviert wird ein Link am Ende der E-Mail eingefügt der zu der jeweiligen Seite führt.',
        'personal_greeting' => 'Persönliche Anrede',
        'personal_greeting_desc' => 'Wenn aktiviert, wird der Empfänger der E-Mail mit seinem Namen angesprochen. Deaktiviert, wird keine Begrüßung erstellt!',
        'attachments' => 'E-Mail Anhänge',
        'attachments_desc' => 'Sollen Dateien der E-Mail angehängt werden?',
    ],
    ...
    'footer' => [
        'unsubscribe_text' => 'Möchten Sie diese E-Mails nicht mehr erhalten? Sie können',
        'unsubscribe_link' => 'hier abbestellen',
    ],
];
